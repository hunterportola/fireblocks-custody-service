...
# Workflow Test Harness - Tests the complete originator workflow
...
echo "🚀 Workflow Test - Fireblocks Custody Service"
echo "================================================="
echo ""
...
# Test 2: Tenant Authentication (ACME Lending)
echo -e "${YELLOW}Test 2: Tenant Authentication${NC}"
...
if echo "$ORIGINATOR_RESPONSE" | grep -q "originator_acme_lending"; then
    echo -e "${GREEN}✅ Tenant auth passed${NC}"
else
    echo -e "${RED}❌ Tenant auth failed${NC}"
fi
echo ""

# Test 3: Create Disbursement (ACME Lending)
echo -e "${YELLOW}Test 3: Create Disbursement${NC}"
...
# Test 4: List Disbursements
echo -e "${YELLOW}Test 4: List Disbursements${NC}"
...
# Test 5: Sepolia Disbursement Smoke Test
echo -e "${YELLOW}Test 5: Sepolia Disbursement${NC}"
...
echo "This workflow test demonstrates:"
echo "1. ✅ API server is running and healthy"
echo "2. ✅ Tenant authentication is working"
...
echo ""
echo -e "${GREEN}Workflow is ready for testing!${NC}"
echo ""
echo "Next steps:"
